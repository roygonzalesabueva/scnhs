...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `filesscnhs_history` WHERE  CONCAT(`id`, `name`,`date_updated`)LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
    else {
        $query ="SELECT * FROM `filesscnhs_history`ORDER BY id DESC";
        $search_result = filterTable($query);
...
<nav class="navbar " style="padding:0;">
  ...
  <img src="memo.png" width="355" height="70">
      ...
      <a href="filesscnhs.php"><font color="Black"><B>Close</B></a></font>
      </div>
...
<div class="row">
         ...
         <form action="filesscnhs_history.php" method="post" enctype="multipart/form-data">
...
<?php while($row = mysqli_fetch_array($search_result)): ?>
        ...
        <tr> 
            ...
            <td>
            <a href="transferscnhs_historydel.php?id=<?php echo $row['id']?>">Delete</a>
            </td>
