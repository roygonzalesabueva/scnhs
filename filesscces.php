...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `filesscces` WHERE  CONCAT(`id`, `name`,`date_updated`)LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
    else {
        $query ="SELECT * FROM `filesscces`ORDER BY id DESC";
        $search_result = filterTable($query);
...
<nav class="navbar " style="padding:0;">
  ...
  <a href="filesscces_history.php"> <i class="material-icons" style="font-size:36px;color:Blue">cloud_queue</i><font color="Black"><B>Drive</B></font></a> 
...
<div class="row">
         ...
         <form action="filesscces.php" method="post" enctype="multipart/form-data">
...
<a href="transferscces_history.php?id=<?php echo $row['id']?>">Remove</a>
            ...
            <td>
            <a href="transferscces_history.php?id=<?php echo $row['id']?>">Save to Drive</a>
            </td>
        </tr>
<?php endwhile;?>
